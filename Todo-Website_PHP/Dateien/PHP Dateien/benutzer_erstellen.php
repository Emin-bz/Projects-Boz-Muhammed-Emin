...
// Initialisierung
$error = $message =  '';
$firstname = $lastname = $email = $username = $kategorie = '';
...
if($_SERVER['REQUEST_METHOD'] == "POST"){
  ...
  if(isset($_POST['rights']) && !empty(trim($_POST['rights'])) && strlen(trim($_POST['rights'])) <= 30){
...
//------------------------------- In die Datenbank schreiben ----------------------------------------
  if(empty($error)) {
    ...
    $query = "Insert into user (firstname, lastname, username, password, email) values(?,?,?,?,?);";
  ...
  <body>
    ...
    <div class="container">
      ...
      <form action="" method="post">
        ...
        <button type="submit" name="create" value="submit" class="btn btn-info">Senden</button>
